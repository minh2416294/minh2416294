# Tran Binh Minh
I make **multi-agent** and **agentic coding systems** safe by design, turning abstract policy goals into deterministic constraints, not prompting. I contribute correctness/trust fixes to the open-source agent tools I use, and I'm working on an **eval harness** that judges agentic-coding traces (diff quality, tool choice, task completion) to make agent competence more quantifiable. I'm judicious about what gets automated and what stays human-in-the-loop.
